...
<body>
    <div class="container-full-height columns">
        ...
        <main class="column is-four-fifths">
            <h1 class="title">查询教师</h1>
            <!-- 表单 -->
            <form action="/admin/teacher/retrieve" method="post">
                <!-- 表单项 -->
                <div class="field is-horizontal">
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control">
                                <input class="input is-small" type="text" id="TeacherId" name="TeacherId" pattern="[0-9]{6}">
                            </div>
                        </div>
                    </div>
                    <div class="field-label is-normal">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="field is-grouped">
                                <div class="control">
                                    <form action="/admin/teacher/update" method="get">
